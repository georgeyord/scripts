...
wget -qO- https://raw.githubusercontent.com/georgeyord/scripts/master/debian/files/byobu/.git-prompt-colors.sh > /home/$DEFAULT_USER/.git-prompt-colors.sh
...
if grep -Fxq "/home/$DEFAULT_USER/.bashrc" gitprompt; then
    ...
    echo "source ~/.bash-git-prompt/gitprompt.sh" >> /home/$DEFAULT_USER/.bashrc
fi
